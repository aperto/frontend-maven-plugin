...
public abstract class AbstractNpmMojo extends AbstractFrontendMojo {
    ...
    protected abstract void executeNpm(FrontendPluginFactory factory, ProxyConfig proxyConfig) throws TaskRunnerException;
