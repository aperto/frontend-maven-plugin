...
public abstract class Executor {
    ...
    public Executor(NodeExecutorConfig config, List<String> arguments, Map<String, String> additionalEnvironment){
        final String node = getExecutablePath(config);
    ...
    protected abstract String getExecutablePath(NodeExecutorConfig config);
